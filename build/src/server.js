...
(0, dotenv_1.config)();
var _a = (0, pg_connection_string_1.parse)(process.env.POSTGRES_URL), host = _a.host, port = _a.port, username = _a.user, password = _a.password, database = _a.database;
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    var connectionOptions, PORT, server;
