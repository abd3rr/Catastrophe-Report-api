...
var ALLOWED_IMAGE_EXTENSIONS = ['.png', '.jpg', '.jpeg', '.gif', '.bmp', '.svg', '.webp', '.tiff'];
...
var fileFilter = function (req, file, cb) {
    ...
    if (ALLOWED_IMAGE_EXTENSIONS.includes(fileExt)) {
        ...
        cb(new Error("Invalid file type. Only ".concat(ALLOWED_IMAGE_EXTENSIONS.join(', '), " are allowed.")), false);
    }
};
...
var UploadImageService = /** @class */ (function () {
    ...
    UploadImageService.prototype.bytesToMegabytes = function (bytes) {
        return Math.round((bytes / 1048576) * 100) / 100; // rounded to two decimal places
    };
    UploadImageService.prototype.any = function () {
        return upload.any();
    };
    UploadImageService.prototype.getMetaData = function (file) {
...
//# sourceMappingURL=UploadImageService.js.map